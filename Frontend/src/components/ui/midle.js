...
return (
    <div id='G_Content'>
        <div id='T_Content'>
            <div id='titre'>
            <div style={{display:"inline" ,fontFamily: "michroma"}}>Votre <span style={{color:"#1C6BBD" , display:"inline"}}>C</span>onfort est Notre <span style={{color:"#1C6BBD", display:"inline"}}>P</span>riorité</div>
            <Link to={"/cars"}><button id='B_t' style={{width:"400px" ,height:"70px"}}>Votre voiture est là</button>
            </Link>
            </div>
        </div>
