    ...
    <div id='footer'>
      <div id='lef_footer'>
        ...
        <div id='media'>
          ...
          <img alt='' src={whatsap} width={45} />
          <img src={twitter} height={38} width={40} />
          <img src={insta} width={45} />
        </div>
      </div>
      <div id='center_footer'>
        <p style={{ textAlign: 'center' }}>
          Wheels deal est assujetti à la loi N° 09-08, relative à la protection
          des personnes physiques à l'égard du traitement des données
          personnelles et elle a pris ses dispositions pour en respecter la
          lettre et l'esprit.
        </p>
        <p style={{ textAlign: 'center' }}>
      ...
      <div id='righ_footer'>
        <p>note :</p>
        <img src={starBleu} alt='' style={{ margin: '2%' }} width={20} />
        <img src={starBleu} style={{ margin: '2%' }} width={20} />
        <img src={starBleu} style={{ margin: '2%' }} width={20} />
        <img src={starBleu} style={{ margin: '2%' }} width={20} />
        <img src={starBlack} style={{ margin: '2%' }} width={20} />
      </div>
    </div>
  )
}
